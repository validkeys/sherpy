...
export class ListDocumentsParams extends Schema.Class<ListDocumentsParams>(
  "ListDocumentsParams"
)({
  projectId: Schema.String,
}) {}
...
export class GetDocumentParams extends Schema.Class<GetDocumentParams>(
  "GetDocumentParams"
)({
  projectId: Schema.String,
  documentType: Schema.Literal("implementation-plan"),
...
export class DocumentsApi extends HttpApiGroup.make("documents")
  ...
  .add(
    HttpApiEndpoint.get("getDocumentVersion", "/projects/:projectId/documents/:documentType/versions/:version")
