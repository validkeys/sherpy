 ...
 */
export class PersonSkillService extends Effect.Service<PersonSkillService>()("PersonSkillService", {
  effect: Effect.gen(function* () {
    ...
    ): Effect.Effect<typeof PersonSkill.Type, ConflictError | NotFoundError | ValidationError> =>
      Effect.gen(function* () {
