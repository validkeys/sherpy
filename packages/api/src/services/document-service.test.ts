...
describe("DocumentService", () => {
  it.scoped(
    "generateProjectPlan - creates YAML document",
    () =>
      Effect.gen(function* () {
  ...
  it.scoped(
    "generateProjectPlan - creates Markdown document",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "generateProjectPlan - creates JSON document",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "generateProjectPlan - increments version on regeneration",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "generateProjectPlan - reflects current DB state",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "generateProjectPlan - fails for non-existent project",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "getDocument - returns latest version",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "getDocument - fails for non-existent document type",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "listDocuments - returns all documents for project",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "listDocuments - returns empty array for project with no documents",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "getDocumentVersion - returns specific version",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
        ...
        const v1 = yield* documentService.getDocumentVersion(project.id, "implementation-plan", 1);

        const v2 = yield* documentService.getDocumentVersion(project.id, "implementation-plan", 2);
  ...
  it.scoped(
    "getDocumentVersion - fails for non-existent version",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
  ...
  it.scoped(
    "generateProjectPlan - handles empty project (no milestones)",
    () =>
      Effect.gen(function* () {
        const sql = yield* makeTestDb;
        yield* runMigrations.pipe(Effect.provideService(SqlClient.SqlClient, sql));
